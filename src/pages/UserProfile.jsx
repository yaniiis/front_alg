...
export default function UserProfile() {
  ...
  const handleAddFriend = async () => {
    await fetch(`http://localhost:3001/friendRequest/:userId`, {
      ...
      body: JSON.stringify({ sender_id: localStorage.getItem("userId")}), // remplacer 999 par l'ID de l'utilisateur connecté
    });
        ...
        <div className="bg-white rounded-xl shadow-md p-6 flex items-center gap-6 mb-6">
          ...
          <div className="flex-1">
            ...
            <div className="mt-4 flex gap-3">
              ...
              <button className="px-4 py-2 bg-indigo-600 text-white rounded-xl text-sm">Suivre</button>
              <button className="px-4 py-2 bg-red-500 text-white rounded-xl text-sm">Bloquer</button>
